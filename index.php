...
?>
      <div class="row banner">
         <div class="banner-text">
            <h1  text-shadow: 10px 10px #ff0000 class="responsive-headline">I'm <?php echo isset($user) ? ucwords($user['firstname'].' '.$user['lastname']) : ""; ?>.</h1>
   ...
   <section id="about">
      ...
      <div class="row">
         ...
         <div class="three columns">
            ...
            <img class="profile-pic"  src="<?php echo validate_image($_settings->info('logo')) ?>" alt='avatar' />
          ...
          ?>
            <div class="row item">
               ...
               <div class="twelve columns">
                  ...
                  <p class="info"><?php echo $row['position'] ?> <span>&bull;</span><em class="date"></em></p>
